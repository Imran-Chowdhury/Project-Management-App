...
import 'package:project_management_app/view_models/home_view_model/project_view_model.dart';
...
//    await projectController.readMapFromSharedPreferences('project_file');
...
// //       success: (projects) => ListView.builder(
...
//     if(projectState == LoadingState){
//       return const Center(child: CircularProgressIndicator(),);




//     }else if(projectState==SuccessState){
...
//     else{
//       return Scaffold(body: Text('lalalala'),); // Placeholder widget for unexpected state
//     }
