...
class PieChartScreen extends ConsumerStatefulWidget {
  ...
  PieChartScreen({super.key, required this.projectName, required this.listOfTasks, required this.description});
          ...
          Expanded(
            child: Stack(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(left:width*.3,top:height*.26,bottom: height*.1),
                  child: const Text(
                    'Progress Report',
                    style:  TextStyle(
                      color: Colors.black45,
                ...
                Padding(
                  padding: EdgeInsets.only(bottom: height*.2), // Adjust this value to move the chart upward
                  child: PieChart(
